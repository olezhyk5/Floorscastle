...
var _lightbox = _interopRequireDefault(require("lightbox2/dist/js/lightbox"));
...
(function ($) {
  ...
  function initMapList($el) {
    // Find marker elements within map.
    var locations = fc_object.map_locations; // Create gerenic map.
    ...
    var infowindow = new google.maps.InfoWindow(); // Add markers.
